...
const BULLDOZER_IMG = "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=800&q=80";
      ...
      <div className="sticky top-0 h-screen overflow-hidden bg-background">
          ...
          {[...Array(8)].map((_, i) => (
            <div
              ...
              style={{
                ...
                left: `${(i * 12) - 30}px`,
                bottom: `${(i * 5) % 40}px`,
                animation: "landing-float 2s ease-out infinite",
        ...
        >
          <img
            ...
            className="w-full h-auto drop-shadow-[0_0_40px_rgba(255,205,17,0.3)] object-cover rounded-lg"
          />
        </div>
